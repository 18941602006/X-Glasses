...
基线 5201b13b530350f3e9bf5161cb6cfedd24d7894d，拟备份 backup/pre-phase2a-firmware-20260905-0300；核验后实施固定 ESP-IDF/组件、协议/会话/相机/传感器接口/有限告警与构建/跨语言验证，具体边界见 DEV_PROGRESS。没有枚举到串口，固件不烧录不明设备，实际硬件项保留未验收，继续可独立软件工作。
