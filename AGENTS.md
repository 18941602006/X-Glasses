...
当前实施范围 Phase 2A USB 软件；Phase 0/1 审核已交付。协议/输入/回放核心已建立，固件、真实 CDC、握手/对时/ACK 与实机验收待完成，不能标整个 2A 通过。读 docs/protocol/USB_V1.md，阶段状态以最新 HANDOFF 为准。2B 为新电脑前端；Android 工程仅 Phase 6 建立。
